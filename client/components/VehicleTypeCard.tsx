...
export const VehicleTypeCard: React.FC<VehicleTypeCardProps> = ({
  ...
  // Vehicle type specific images from Builder.io asset library
  const vehicleTypeImages: { [key: string]: string } = {
    ...
    'Van / Minivan': 'https://cdn.builder.io/api/v1/image/assets%2F4d1f1909a98e4ebc8068632229306ce4%2F24bf3ece0537462bbd1edd12a2485c0a',
